...
description: A technical overview of CodeBuddy's agent orchestration system built on LangGraph Deep Agents, including subagent specialization, composite backends, middleware, tool routing, and execution pipeline.
---
